...
class DistractionListServiceFirebase @Inject constructor(pathProcrastinationActivity: String, pathTag: String) : DistractionListModel {
    private val pathStringProcrastinationActivity = pathProcrastinationActivity
    private val pathStringTags = pathTag
